...
<body>
  ...
  <h1>About Us Page</h1>
  <p>FINAL YEAR PROJECT 2</p>
  <p>UNIVERSITI SULTAN AZLAN SHAH</p>
</div>
...
<div class="row">
  <div class="column">
    <div class="card">
      <div class="container">
      <img src="admin\assets\img\hajar.jpeg" alt="hajar" style="max-height: 400px;min-height: 100px">
        <h2>SITI HAJAR</h2>
        <p class="title">DIPLOMA TEKNOLOGI MAKLUMAT</p>
        <p>PELAJAR FYP 2</p>
        <p>aiqhajar11@gmail.com</p>
        <p>013-3709013</p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <div class="container">
      <img src="admin\assets\img\fatini.jpeg" alt="fatini" style="max-height: 400px;min-height: 100px">
        <h2>NUR FATINI ANIS</h2>
        <p class="title">DIPLOMA TEKNOLOGI MAKLUMAT</p>
        <p>PELAJAR FYP 2</p>
        <p>nurfatinianis73@gmail.com</p>
        <p>017-4605813</p>
      </div>
    </div>
  </div>
