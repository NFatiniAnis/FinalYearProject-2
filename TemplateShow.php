...
$result = $db->query("SELECT * FROM resumetemplate WHERE id  LIMIT 1"); 
?>
...
<img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['template_img']); ?>" alt="" style="width:50%" />
<a href="resumePersonalinfo.php?id=<?php echo $row["id"]; ?>" class="btn btn-secondary py-md-3 px-md-5">Edit This</a>
